...
plt.plot(lr_fpr, lr_tpr, marker='.', label='Naive Bayes: AUC=%.3f' % (lr_auc))
# axis labels
...
# summarize scores
print('Naive Bayes: f1=%.3f auc=%.3f' % (lr_f1, lr_auc))
# plot the precision-recall curves
no_skill = len(y_test[y_test==1]) / len(y_test)
plt.plot([0, 1], [no_skill, no_skill], linestyle='--', label='No Skill')
plt.plot(lr_recall, lr_precision, marker='.', label='Naive Bayes: f1=%.3f auc=%.3f' % (lr_f1, lr_auc))
# axis labels
plt.xlabel('Recall')
